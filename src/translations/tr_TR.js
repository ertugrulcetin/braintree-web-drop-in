...
module.exports = {
  payingWith: '{{paymentSource}} ile ödeniyor',
  chooseAnotherWayToPay: 'Başka bir ödeme methodu seçin',
  chooseAWayToPay: 'Ödeme yolu seçiniz',
  otherWaysToPay: 'Başka ödeme yolları',
  cardVerification: 'Kart Doğrulama',Doğ
  // Errors
  fieldEmptyForCvv: 'Lütfen CVV alanını doldurunuz.',
  fieldEmptyForExpirationDate: 'Lütfen son kullanma tarihini doldurunuz.',
